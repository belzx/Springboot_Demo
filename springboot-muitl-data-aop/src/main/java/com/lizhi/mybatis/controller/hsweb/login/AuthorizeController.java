...
package com.lizhi.mybatis.controller.hsweb.login;
...
//            userService.initAdminUser(user);  //给此user 附加所有模块所有的权限
        	System.out.println("开始注入admin的权限");
        else
            user.initRoleInfo();
        User newUser = user;
        ...
        return ResponseMessage.ok("2222");
    }
